...
var DynamoDBDataLoader = /** @class */ (function () {
    function DynamoDBDataLoader(ddbConfig) {
        ...
        if (!tableName || !endpoint) {
            throw new Error("Invalid DynamoDBConfig ".concat(JSON.stringify(ddbConfig, null, 4)));
        }
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'BatchPutItem': return [3 /*break*/, 15];
                            case 'BatchDeleteItem': return [3 /*break*/, 15];
                        }
                        return [3 /*break*/, 16];
                    ...
                    case 15: throw new Error("Operation  ".concat(payload.operation, " not implemented"));
                    case 16: throw new Error("Unknown operation name: ".concat(payload.operation));
    ...
    DynamoDBDataLoader.prototype.deleteAllItems = function () {
        var _a, e_2, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var items, _d, items_1, items_1_1, item, e_2_1, e_3;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        _d = true, items_1 = __asyncValues(items);
                        _e.label = 3;
                    case 3: return [4 /*yield*/, items_1.next()];
                    case 4:
                        if (!(items_1_1 = _e.sent(), _a = items_1_1.done, !_a)) return [3 /*break*/, 9];
                        _c = items_1_1.value;
                        _d = false;
                        _e.label = 5;
                    case 5:
                    ...
                    case 11:
                        ...
                        if (!(!_d && !_a && (_b = items_1.return))) return [3 /*break*/, 13];
                    ...
                    case 17:
                        e_3 = _e.sent();
                        throw new Error("Error while deleting all items from ".concat(this.tableName));
                    case 18: return [2 /*return*/, [this.tableName]];
                }
            });
        });
    };
