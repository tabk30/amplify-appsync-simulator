...
function generateResolvers(schema, resolversConfig, simulatorContext) {
    ...
    var appSyncScalars = new graphql_1.Source(Object.keys(appsync_scalars_1.scalars)
        .map(function (scalar) { return "scalar ".concat(scalar); })
        .join('\n'), 'AppSync-scalar.json');
    var documents = [schema, appSyncScalars, (0, directives_1.getDirectiveTypeDefs)()].map(function (s) { return (0, graphql_1.parse)(s); });
    var doc = (0, graphql_1.concatAST)(__spreadArray([], documents, true));
    var resolvers = resolversConfig.reduce(function (acc, resolverConfig) {
        ...
        typeObj[resolverConfig.fieldName] = __assign({ resolve: function (source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            ? {
                subscribe: function (source, args, context) {
    ...
    return (0, directives_1.transformSchemaWithDirectives)((0, schema_1.makeExecutableSchema)({
        typeDefs: doc,
        resolvers: __assign(__assign({}, resolvers), appsync_scalars_1.scalars),
    }), simulatorContext);
}
...
function generateDefaultSubscriptions(doc, configuredResolvers, simulatorContext) {
    ...
    var schema = (0, graphql_1.buildASTSchema)(doc);
