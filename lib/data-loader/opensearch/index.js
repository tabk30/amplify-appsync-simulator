...
var amplify_cli_core_1 = require("@aws-amplify/amplify-cli-core");
var amplify_prompts_1 = require("@aws-amplify/amplify-prompts");
var OpenSearchDataLoader = /** @class */ (function () {
    function OpenSearchDataLoader(_config) {
        this._config = _config;
    }
    OpenSearchDataLoader.prototype.load = function (payload) {
        var _a;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._config.invoke(payload)];
                    case 1: return [2 /*return*/, _b.sent()];
                    case 2:
                        e_1 = _b.sent();
                        amplify_prompts_1.printer.info('Opensearch Data source failed with the following error:' + (e_1 === null || e_1 === void 0 ? void 0 : e_1.message));
