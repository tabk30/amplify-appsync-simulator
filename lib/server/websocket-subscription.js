...
var AppSyncSimulatorSubscriptionServer = /** @class */ (function () {
    function AppSyncSimulatorSubscriptionServer(simulatorContext, server, subscriptionPath) {
        if (subscriptionPath === void 0) { subscriptionPath = server_1.REALTIME_SUBSCRIPTION_PATH; }
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        jwt = (0, auth_helpers_1.extractJwtToken)(authorization);
                        ...
                        return [4 /*yield*/, (0, subscriptions_1.runSubscription)(this.simulatorContext.schema, doc, variable, operationName, executionContext)];
                    case 1:
        ...
        this.authorizeRequest = function (headers) {
            return (0, auth_helpers_1.getAuthorizationMode)(headers, _this.simulatorContext.appSyncConfig);
        };
    ...
    AppSyncSimulatorSubscriptionServer.prototype.stop = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.realtimeServer.stop()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
